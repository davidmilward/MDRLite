...
public class DocumentController {
    ...
    public String createdoc(@Valid Document document,
    	...
    	document.setSz(content.getSize());
    ...
    public String show(@PathVariable("id") Long id, Model model) {
    	...
    	//doc.setUrl("http://localhost:8080/MdrLite/documents/showdoc/"+id);
    ...
    public String updateForm(@PathVariable("id") Long id, Model model) {
    	...
    	//document.setUrl("http://localhost:8080/MdrLite/documents/showdoc/"+id);
        model.addAttribute("document", document);
